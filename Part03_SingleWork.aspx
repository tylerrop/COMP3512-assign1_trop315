<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Part03_SingleWork.aspx.cs" Inherits="Part03_SingleWork" %>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
              ...
              <div class="navbar-form navbar-right">
                    ...
                    <!--Search button-->
                    <asp:Button ID="RightSubmit" runat="server" Text="Search" CssClass="btn btn-primary" OnClick="NavBarSearch_ArtworkPage" />
                    <!--End of search form-->
              </div>
